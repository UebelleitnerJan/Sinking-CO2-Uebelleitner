...
[Mesh]
  [file]
    ...
    #file = 'task_2D.msh'
    file = 'Equi2_Switch_lowerInj_out.e'
...
#    order = FIRST
#    family = LAGRANGE
#     initial_from_file_var = viscocity_water
#     initial_from_file_timestep = LATEST
#  []
   [temp]
      order = FIRST
...
[DiracKernels] # Point source and point sink code/elements
  ...
  [fluid_production]
    ...
    point_file = 'well_out_Switch.bh' # PeacemanBorehole requires point file
...
[Controls]
  [delay]
    type = TimePeriod
    enable_objects = 'BCs::injection_temperature'
    start_time = 86400
    end_time = 946728000
  []
[]    
